...
<html lang="en">
	<head>
		<title>Admin | Add Police Officers</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Police Officer</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add Police Officer</h5>
												</div>
...
<div class="form-group">
					...
					<textarea name="clinicaddress" class="form-control"  placeholder="Enter Police Officer Address" required="true"></textarea>
														</div>
...
<div class="form-group">
					...
					<input type="text" name="doccontact" class="form-control"  placeholder="Enter Police Officer Contact no" required="true">
														</div>
...
<input type="email" id="docemail" name="docemail" class="form-control"  placeholder="Enter Police Officer Email id" required="true" onBlur="checkemailAvailability()">
