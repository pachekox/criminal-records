			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Criminal | Add Criminal</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Criminal</span>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Add Criminal</h5>
											</div>
											<div class="panel-body">
												<form role="form" name="" method="post">
													...
													<div class="form-group">
														...
														<input type="text" name="patcontact" class="form-control" placeholder="Enter Criminal Contact no" required="true" maxlength="10" pattern="[0-9]+">
													</div>
													<div class="form-group">
														<label for="fess">
															Criminal Email
														</label>
														<input type="email" id="patemail" name="patemail" class="form-control" placeholder="Enter Criminal Email id" required="true" onBlur="userAvailability()">
