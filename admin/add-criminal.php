...
<html lang="en">
	<head>
		<title>Admin | Add Criminal</title>
...
<input type="text" name="patcontact" class="form-control"  placeholder="Enter Criminal ID Number" required="true" maxlength="10" pattern="[0-9]+">
</div>
<div class="form-group">
<label for="fess">
Criminal Phone
</label>
<input type="email" id="patemail" name="patemail" class="form-control"  placeholder="Enter Criminal Phone" required="true" onBlur="userAvailability()">
