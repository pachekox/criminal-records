...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert   tblmedicalhistory(lawyerID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$bp','$bs','$weight','$temp','$pres')");
    if ($query) {
    echo '<script>alert("Medicle history has been added.")</script>';
    echo "<script>window.location.href ='manage-lawyer.php'</script>";
  }
  else
    {
...
Lawyers Details</td></tr>
  ...
  <tr>
    <th scope>Lawyer Mobile Number</th>
    <td><?php  echo $row['lawyerContno'];?></td>
    <th>Lawyer Address</th>
    <td><?php  echo $row['lawyerAdd'];?></td>
  </tr>
    <tr>
    <th>Lawyer Gender</th>
